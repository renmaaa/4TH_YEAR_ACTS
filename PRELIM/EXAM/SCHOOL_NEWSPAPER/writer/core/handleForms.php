...
$db = new Database();
$pdo = $db->connect(); // Get the PDO connection

$userObj = new User($pdo); // Pass PDO connection
$articleObj = new Article($pdo); // Pass PDO connection
...
if (isset($_POST['editArticleBtn'])) {
    ...
    if ($articleObj->updateArticle($article_id, $title, $description, $image_path, $category_id)) { // Pass category_id
