        ...
        <div class="articleCard">
          ...
          <div class="updateArticleForm mt-3 d-none" id="editForm<?php echo $article['article_id']; ?>">
            ...
            <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="category_id_<?php echo $article['article_id']; ?>">Category</label>
                <select class="form-control" id="category_id_<?php echo $article['article_id']; ?>" name="category_id">
