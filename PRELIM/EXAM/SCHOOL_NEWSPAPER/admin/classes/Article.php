...
class Article extends Database {
    ...
    public function deleteCategory($category_id) {
        // Before deleting a category, set articles with this category to NULL
        $this->executeNonQuery("UPDATE articles SET category_id = NULL WHERE category_id = ?", [$category_id]);
