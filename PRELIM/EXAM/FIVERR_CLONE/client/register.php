      ...
      <div class="col-md-8 p-4">
        <div class="card">
          ...
          <div class="card-header">
            ...
            <p class="mb-0">Create your account to start hiring top talent</p>
          </div>
          <form action="core/handleForms.php" method="POST">
            <div class="card-body">
              ...
              <div class="form-group form-check">
                <input type="checkbox" class="form-check-input" id="is_fiverr_admin" name="is_fiverr_admin" value="1">
                <label class="form-check-label" for="is_fiverr_admin">Register as Fiverr Administrator</label>
              </div>
